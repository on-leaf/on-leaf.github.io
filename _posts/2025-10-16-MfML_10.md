...
<figure style="display: flex; flex-direction: column; align-items: center; margin-top: 0.5em; margin-bottom: 0.5em;">
  <img src="../images/2025-10-16-MfML_10/Fig_1.png" alt="" 
...
$$\begin{align}
\frac{\partial f}{\partial x_1} &= \lim_{h \to 0} \frac{f(x_1 + h, x_2, \dots, x_n) - f(\vec{x})}{h} \nonumber \\
& \ \ \vdots \tag{5.9} \\
\frac{\partial f}{\partial x_n} &= \lim_{h \to 0} \frac{f(x_1, \dots, x_{n-1}, x_n + h) - f(\vec{x})}{h} \nonumber
\end{align}$$
...
$$\begin{align} \text{Error function}: \vec{e}(\vec{\theta}) &= \vec{y} - \mathbf{\Phi}\vec{\theta} \\ \text{Loss function}: L(\vec{e}) &= \|\vec{e}\|^2\end{align}$$
...
$$ f_i = \sum_{j=1}^{N} A_{ij}x_j, \quad i=1, \dots, M, \to \frac{\partial f_i}{\partial A_{iq}} = x_q. $$
