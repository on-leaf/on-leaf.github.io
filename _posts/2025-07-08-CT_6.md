...
<center>$$\begin{split} g(x,y) &= \int_{0}^{\pi} p_{\gamma}\left( x \cos (\gamma) + y \sin (\gamma) \right) \mathrm{d} \gamma \\ 
                               &= \int_{0}^{\pi} \mathop{\int\int}\limits_{\text{all } \mathbf{r} \in \mathbf{L}} f(\mathbf{r}) \mathrm{d}\mathbf{r} \mathrm{d} \gamma \\
                               &= \int_{0}^{\pi} \mathop{\int\int}\limits_{\text{all } \mathbf{r} \in \mathbb{R}^2} f(\mathbf{r}) \delta(\mathbf{r} - \mathbf{L}) \mathrm{d}\mathbf{r} \mathrm{d} \gamma
                               &=  \end{split} \tag{3.２}$$</center>
{% include end-box.html %}
