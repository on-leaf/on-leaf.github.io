...
The evidence $P(Y)$ acts as a normalization constant, calculated using the sum rule: $P(Y) = \sum_{x'} P(X=x')P(Y|X=x')$ (discrete) or $P(Y) = \int P(X=x')P(Y|X=x') dx'$ (continuous).
