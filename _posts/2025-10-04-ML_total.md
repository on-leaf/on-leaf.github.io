...
{% include start-box.html class="math-box-inner" font_size="0.8em"%}
**MAP**<br>
Goal Setting: MAP (Maximum a Posteriori) Estimation<br>
...
**The Birth of L2 Regularization: Connecting Theory and Practice**
...
According to page 53 of the material, this is defined as: Objective Function = Residual Function + Regularization Function Residual Function: This is the same as the traditional Loss Function.<br> 
It measures the error between the model's predictions and the actual data. <br>
