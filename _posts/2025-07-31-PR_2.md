...
For the single-pixel measurements, photons were randomly incident onto $3\times3$ PCD pixels, and these processes were performed for each of the $3\times3$ pixels in parallel.
