...
for all $i,j=1. \dots, n$ then the basis is called an **_orthogonal basis_**.
...
A linear mapping $\pi: V \rightarrow U$ is called a **_projection_** if $\pi^2 = \pi \circ \pi = \pi$.
...
2.Minimum condition (Assuming the dot product as the inner product) <br>
